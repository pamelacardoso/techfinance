        ...
        const fetchSales = async () => {
            ...
            try {
                ...
                for (const sale of salesData) {
                    totalSalesValue += Number(sale.quantidade_total) ?? 0;
                }
        ...
        >
            <View className="flex-row justify-between items-start mb-4">
                ...
                <View className="bg-blue-50 px-3 py-1 rounded-full">
                    <Text className="text-blue-600 font-medium">{Number(item.quantidade_total).toLocaleString('pt-br', { style: 'decimal' })}</Text>
                </View>
            </View>
        </Animated.View>
    ), [])
    ...
    return (
        <View className="flex-1 bg-gray-50">
            ...
            <View className="flex-1">
                ...
                >
                    <Text className="text-2xl font-bold text-gray-800">Top 10 Variações de Preço</Text>
                    ...
                    <View className="flex-row justify-between items-center mt-6 bg-blue-50 p-4 rounded-2xl">
                        ...
                        <View>
                            <Text className="text-sm text-blue-600 font-medium">Quantidade Total</Text>
