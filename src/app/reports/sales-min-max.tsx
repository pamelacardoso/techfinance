        ...
        >
            <View className="flex-row justify-between items-start mb-4">
                <View className="flex-1">
                    ...
                    <Text>Valor Mínimo: {item.valor_minimo}</Text>
                    <Text>Valor Máximo: {item.valor_maximo}</Text> 
                </View>
                <View className="bg-blue-50 px-3 py-1 rounded-full">
                    <Text className="text-blue-600 font-medium">{Number(item.percentual_diferenca).toFixed(2)}%</Text>
                </View>
            </View>
        </Animated.View>
    ), [])
    ...
    return (
        <View className="flex-1 bg-gray-50">
            ...
            <View className="flex-1">
                ...
                >
                    <Text className="text-2xl font-bold text-gray-800">Top 10 Vendas - Insights em Qtd.</Text>
